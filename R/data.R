...
# a shared inflation trend in a nominal inventory stock and a price index can
# manufacture cointegration on its own, so this guards against that by
# removing the common price-level trend from both sides before logging.
