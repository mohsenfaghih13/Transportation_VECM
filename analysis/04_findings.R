...
# normal approximation. Treat half-lives as descriptive, not as precise
# ratios comparable across models, until CIs are in view.
...
# alpha's t-statistic in the unrestricted fit.
...
# AIC and SBC disagree on every model (6 lags vs 2, typically); check
# whether HQ and FPE side with one or the other, as a
